...
React 18 + Vite + TypeScript frontend for the Quorum AI Committee PoC.
Consumes the Spring Boot backend at `quorum-api/` via the Vite dev
...
| Icons | lucide-react |
| Styles | `pro-styles.css` lifted verbatim from `design_handoff_quorum/` |
