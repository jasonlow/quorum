package io.quorum.audit.verify;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.quorum.platform.audit.CanonicalSerializer;
...
public final class VerifyCli {
    ...
    private static final String DEFAULT_PUBLIC_KEY = "./data/keys/quorum-public.pem";
